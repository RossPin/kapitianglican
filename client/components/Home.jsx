      ...
      <div>
        ...
        <div className='about'>
          ...
          {/* <div className='tileBoard'>
            <Link className='parishTile' to={'/OurChurches/stPauls'}><h4>St Paul's</h4><img src='images/stPauls.jpeg' /></Link>
            <Link className='parishTile mid' to={'/OurChurches/stMarks'}><h4>St Mark's</h4><img src='images/stMarks.jpeg' /></Link>
