    ...
    return (
      <div className='services'>
        ...
        <div className='content'>
          <h2>Sunday Service Worship Times</h2>
          <div className='section'>
            ...
            <h3>St Mark’s Church, Rosetta Road, Raumati</h3>
            ...
            <h3>St Peter’s Church, Beach Road, Paekakariki</h3>
            <p><strong>10am - </strong>Traditional Family service with Holy Communion</p>
          </div>
          <div className='section'>
            <h3>St Paul’s Church, Kapiti Road, Paraparaumu</h3>
